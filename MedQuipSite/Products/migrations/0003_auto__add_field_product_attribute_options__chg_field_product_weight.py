...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.attribute_options'
        db.add_column(u'Products_product', 'attribute_options',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Product.weight'
        db.alter_column(u'Products_product', 'weight', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):
        # Deleting field 'Product.attribute_options'
        db.delete_column(u'Products_product', 'attribute_options')


        # Changing field 'Product.weight'
        db.alter_column(u'Products_product', 'weight', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))
