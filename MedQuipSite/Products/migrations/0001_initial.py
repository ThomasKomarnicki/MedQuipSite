...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'Products_category', (
            ...
            ('children_ids', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ...
        db.create_table(u'Products_product', (
            ...
            ('img', self.gf('django.db.models.fields.CharField')(default='0.jpg', max_length=200, blank=True)),
        ...
        db.create_table(u'Products_attribute', (
            ...
            ('price', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('sku', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=4000, blank=True)),
